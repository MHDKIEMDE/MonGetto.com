...
@section('contents')
    <div class="dashboard_content">
        <h2 class="dashboard_title">Modifier le Quartier</h2>
        <div class="dashboard_add_property">
            <div class="add_property_info wow fadeInUp" data-wow-duration="1.5s">
                ...
                @endif
                <form method="POST" action="{{ route('admin.quartier.update', ['quartier' => $quartier->id]) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 d-flex p-4">
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div class="add_property_input">
                                    <a href="{{ route('admin.quartier,show') }}" class="common_btn">Annuler</a>
                                </div>
                            </div>
                        </div>
                </form>
