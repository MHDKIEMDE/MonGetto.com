                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-7 col-lg-5 wow fadeInLeft" data-wow-duration="1.5s">
                            <div class="agent_details_area_img">
                                <img src="assets/images/agent_details_img.jpg" alt="agent" class="img-fluid w-100">
                        ...
                        <div class="col-xl-8 col-md-12 col-lg-7 wow fadeInRight" data-wow-duration="1.5s">
                            <div class="agent_details_area_text">
                                ...
                                <p><b>Hello! This is Hanson Deck.</b> Morbi a nunc, et rutrum libero. In posuere velit sed
                                    velit
                                    maximus eu enenatis sem rhoncus. Praesent quam augue, egestas vitae tempus non posuere
                                ...
                                <ul class="agent_social_media d-flex flex-wrap">
                                    <li><a class="common_btn" href="#"><i class="fas fa-envelope"></i>Send Email</a>
                                    </li>
                    ...
                    <div class="row mt_25">
                            ...
                            <div class="single_property">
                                ...
                                <div class="single_property_text">
                                    ...
                                    <div class="single_property_bottom d-flex flex-wrap justify-content-between">
                                        <a class="read_btn" href="{{ route('user.property_details') }}">More Details<i
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                            <div class="single_property">
                                ...
                                <div class="single_property_text">
                                    <div class="single_property_top">
                                        <a class="item_title " href="{{ route('user.property_details') }}">Leisure
                                            Beautiful
                                            Health</a>
                                        <p><i class="fas fa-map-marker-alt"></i>28B Highgate Road, London</p>
                                        <ul class="d-flex flex-wrap">
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                            <div class="single_property">
                                ...
                                <div class="single_property_text">
                                    <div class="single_property_top">
                                        <a class="item_title" href="{{ route('user.property_details') }}">South Side
                                            Garden
                                            House</a>
                                        <p><i class="fas fa-map-marker-alt"></i>28B Highgate Road, London</p>
                                        <ul class="d-flex flex-wrap">
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                            <div class="single_property">
                                ...
                                <div class="single_property_text">
                                    <div class="single_property_top">
                                        <a class="item_title " href="{{ route('user.property_details') }}">Stunning
                                            mansion in
                                            Reno</a>
                                        <p><i class="fas fa-map-marker-alt"></i>28B Highgate Road, London</p>
                                        <ul class="d-flex flex-wrap">
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                            <div class="single_property">
                                ...
                                <div class="single_property_text">
                                    <div class="single_property_top">
                                        <a class="item_title" href="{{ route('user.property_details') }}">Beautiful Condo
                                            in
                                            London</a>
                                        <p><i class="fas fa-map-marker-alt"></i>28B Highgate Road, London</p>
                                        <ul class="d-flex flex-wrap">
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                            <div class="single_property">
                                ...
                                <div class="single_property_text">
                                    <div class="single_property_top">
                                        <a class="item_title" href="{{ route('user.property_details') }}">Kolte Patil
                                            Life
                                            Republic</a>
                                        <p><i class="fas fa-map-marker-alt"></i>28B Highgate Road, London</p>
                                        <ul class="d-flex flex-wrap">
