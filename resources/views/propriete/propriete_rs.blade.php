...
@section('contente')
                ...
                <div class="row">
                    <div class="col-12 justify-content-center">
                        <div class="breadcrumb_text wow fadeInUp" data-wow-duration="1.5s">
                            <h1>property right sidebar</h1>
                            <ul class="d-flex flex-wrap justify-content-center">
                                <li><a href="#"><i class="fas fa-home"></i>Home</a></li>
                                <li><a href="#">property right sidebar</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section class="property_right_sidebar pt_120 xs_pt_100 pb_120 xs_pb_100">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 property_sm_margin">
                    ...
                    <div class="row">
                        @foreach ($proprietes as $pro)
                            <div class="col-xl-6 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                                <div class="single_property">
                                    ...
                                    <div class="single_property_text">
                                        ...
                                        <span class="property_price">{{ number_format($pro->loyers, 0, ',', ' ') }}FCFA
                                        </span>
                                    </div>
